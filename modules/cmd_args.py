...
parser.add_argument(
    "--skip-python-version-check", action="store_true", help="launch.py argument: do not check python version"
)
parser.add_argument(
...
parser.add_argument(
    "--skip-prepare-environment", action="store_true", help="launch.py argument: skip all environment preparation"
)
...
parser.add_argument(
    "--hypernetwork-dir", type=str, default=os.path.join(models_path, "hypernetworks"), help="hypernetwork directory"
)
parser.add_argument(
    "--localizations-dir", type=str, default=os.path.join(script_path, "localizations"), help="localizations directory"
)
...
parser.add_argument(
    "--lowram", action="store_true", help="load stable diffusion checkpoint weights to VRAM instead of RAM"
)
parser.add_argument(
...
parser.add_argument(
    "--share", action="store_true", help="use share=True for gradio and make the UI accessible through their site"
)
...
parser.add_argument(
    "--enable-insecure-extension-access", action="store_true", help="enable extensions tab regardless of other options"
)
parser.add_argument(
...
parser.add_argument(
    "--use-cpu", nargs="+", help="use CPU as torch device for specified modules", default=[], type=str.lower
)
parser.add_argument(
    "--listen",
    action="store_true",
...
parser.add_argument(
    "--hide-ui-dir-config", action="store_true", help="hide directory configuration from webui", default=False
)
...
parser.add_argument(
    "--opt-channelslast", action="store_true", help="change memory type for stable diffusion to channels last"
)
parser.add_argument(
    "--styles-file", type=str, help="filename to use for styles", default=os.path.join(data_path, "styles.csv")
)
parser.add_argument(
    "--autolaunch",
    action="store_true",
...
parser.add_argument(
    "--disable-console-progressbars", action="store_true", help="do not output progressbars to console", default=False
)
parser.add_argument(
...
parser.add_argument(
    "--tls-keyfile", type=str, help="Partially enables TLS, requires --tls-certfile to fully function", default=None
)
parser.add_argument(
    "--tls-certfile", type=str, help="Partially enables TLS, requires --tls-keyfile to fully function", default=None
)
parser.add_argument(
    "--disable-tls-verify",
    action="store_false",
