...
def create_ui():
    ...
    with gr.Row().style(equal_height=False, variant="compact"):
            ...
            with gr.Tabs(elem_id="mode_extras"):
                with gr.TabItem("Single Image", id="single_image", elem_id="extras_single_tab") as tab_single:
                    extras_image = gr.Image(
                        label="Source", source="upload", interactive=True, type="pil", elem_id="extras_image"
                    )
                ...
                with gr.TabItem(
                    "Batch from Directory", id="batch_from_directory", elem_id="extras_batch_directory_tab"
                ) as tab_batch_dir:
                    ...
                    show_extras_results = gr.Checkbox(
                        label="Show result images", value=True, elem_id="extras_show_extras_results"
                    )
        ...
        with gr.Column():
            result_images, html_info_x, html_info, html_log = ui_common.create_output_panel(
