...
import gradio as gr
import modules.item_creater as creater
    ...
    for i, image in enumerate(images):
        ...
        if is_inpaint_batch:
            ...
            mask_image_path = os.path.join(
                inpaint_mask_dir, os.path.basename(image))
...
def img2img(r: gr.Request, id_task: str, mode: int, prompt: str, negative_prompt: str, prompt_styles, init_img, sketch, init_img_with_mask, inpaint_color_sketch, inpaint_color_sketch_orig, init_img_inpaint, init_mask_inpaint, steps: int, sampler_index: int, mask_blur: int, mask_alpha: float, inpainting_fill: int, restore_faces: bool, tiling: bool, n_iter: int, batch_size: int, cfg_scale: float, image_cfg_scale: float, denoising_strength: float, seed: int, subseed: int, subseed_strength: float, seed_resize_from_h: int, seed_resize_from_w: int, seed_enable_extras: bool, selected_scale_tab: int, height: int, width: int, scale_by: float, resize_mode: int, inpaint_full_res: bool, inpaint_full_res_padding: int, inpainting_mask_invert: int, img2img_batch_input_dir: str, img2img_batch_output_dir: str, img2img_batch_inpaint_mask_dir: str, override_settings_texts, *args):
    ...
    succ, coin = creater.create_aigc_item_subcoin(
        r, "img2img", model_name, input_data)
    if not succ:
    ...
    succ = creater.create_aigc_item(r, "img2img", model_name, input_data,
