...
def img2img(
    ...
    *args,
    ...
    succ, coin = creater.create_aigc_item_subcoin(r, "img2img", model_name, input_data)
    if not succ:
    ...
    succ = creater.create_aigc_item(r, "img2img", model_name, input_data, processed.images, generation_info_js)
    if not succ:
