...
def wrap_gradio_gpu_call_with_request(func, extra_outputs=None):
    ...
    return wrap_gradio_call_with_request(f, extra_outputs=extra_outputs, add_stats=True)
...
def wrap_gradio_call_with_request(func, extra_outputs=None, add_stats=False):
    def f(r: gr.Request, *args, extra_outputs_array=extra_outputs, **kwargs):
